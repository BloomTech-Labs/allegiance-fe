				...
				<InfoHolder>
					<Name>
						...
						{props.match.url === "/profile"
							? <Link to="/makeprofile"><Icon name="edit outline" /> </Link>
							: null}
					</Name>
					...
					<ImageHolder>
						<Modal closeIcon trigger={<UserImage src="https://react.semantic-ui.com/images/wireframe/image.png" rounded size="tiny" />}>
							<Modal.Content image>
								<Image wrapped src='https://react.semantic-ui.com/images/wireframe/image.png' />
							</Modal.Content>
						</Modal>
						<Modal closeIcon trigger={<UserImage src="https://react.semantic-ui.com/images/wireframe/image.png" rounded size="tiny" />}>
							<Modal.Content image>
